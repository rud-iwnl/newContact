            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-900 dark:text-white mb-2">❓ 2. Задавание ассоциации</h3>
                    <p>Остальные игроки по очереди задают ассоциации, намекая на своё предположительное слово.</p>
                    <p className="mt-2 font-semibold">Важно:</p>
                    <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                      <li>Ассоциации должны быть составлены так, чтобы ведущий не понял, о каком слове идёт речь.</li>
                      <li>Пример: "Светит" (намёк на "солнце").</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <p>Слова должны начинаться на те же буквы, что и загаданное слово. Если оба игрока написали одно и то же слово, это считается успешным контактом.</p>
